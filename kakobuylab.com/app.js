...
const ui = {
  en: {
    ...
    heroTag: "Buy smarter. Inspect everything.", heroTitle: "Kakobuy Spreadsheet, W2C Links & QC Guide", heroCopy: "A practical Kakobuy research hub for W2C links, QC checks, shipping estimates, coupons and fee clarity.", heroPrimary: "Spreadsheet", heroSecondary: "WhatsApp Support ↗",
  ...
  zh: {
    navProducts: "商品发现", navShipping: "运费", navCoupons: "优惠券", navGuides: "购买指南", navFaq: "常见问题", navCta: "Spreadsheet",
    heroTag: "买得更聪明，验得更仔细。", heroTitle: "Kakobuy 表格、W2C 链接与 QC 验货指南", heroCopy: "围绕 Kakobuy 的 W2C 链接、QC 验货、运费预估、优惠券和费用说明，提供一站式实用信息。", heroPrimary: "Spreadsheet", heroSecondary: "WhatsApp 联系我们 ↗",
  ...
  de: {
    navProducts:"Funde",navShipping:"Versand",navCoupons:"Gutscheine",navGuides:"Ratgeber",navFaq:"FAQ",navCta:"Spreadsheet",
    heroTag:"Smarter kaufen. Alles prüfen.",heroTitle:"Kakobuy Spreadsheet, W2C-Links & QC-Ratgeber",heroCopy:"Praxiswissen zu W2C-Links, QC-Fotos, Versand, Gutscheinen und Gebühren bei Kakobuy.",heroPrimary:"Spreadsheet",heroSecondary:"WhatsApp-Kontakt ↗",
  ...
  fr: {
    navProducts:"Trouvailles",navShipping:"Livraison",navCoupons:"Coupons",navGuides:"Guides",navFaq:"FAQ",navCta:"Spreadsheet",
    heroTag:"Achetez mieux. Vérifiez tout.",heroTitle:"Tableur Kakobuy, liens W2C et guide QC",heroCopy:"Un guide pratique des liens W2C, photos QC, frais de port, coupons et tarifs Kakobuy.",heroPrimary:"Spreadsheet",heroSecondary:"Contacter sur WhatsApp ↗",
  ...
  es: {
    navProducts:"Hallazgos",navShipping:"Envíos",navCoupons:"Cupones",navGuides:"Guías",navFaq:"FAQ",navCta:"Spreadsheet",
    heroTag:"Compra mejor. Revisa todo.",heroTitle:"Hoja de cálculo Kakobuy, enlaces W2C y guía QC",heroCopy:"Guía práctica de enlaces W2C, fotos QC, envíos, cupones y comisiones de Kakobuy.",heroPrimary:"Spreadsheet",heroSecondary:"Contactar por WhatsApp ↗",
  ...
  it: {
    navProducts:"Prodotti",navShipping:"Spedizione",navCoupons:"Coupon",navGuides:"Guide",navFaq:"FAQ",navCta:"Spreadsheet",
    heroTag:"Compra meglio. Controlla tutto.",heroTitle:"Spreadsheet Kakobuy, link W2C e guida QC",heroCopy:"Guida pratica a link W2C, foto QC, spedizioni, coupon e commissioni Kakobuy.",heroPrimary:"Spreadsheet",heroSecondary:"Contatta su WhatsApp ↗",
  ...
  pt: {
    navProducts:"Achados",navShipping:"Envio",navCoupons:"Cupons",navGuides:"Guias",navFaq:"FAQ",navCta:"Spreadsheet",
    heroTag:"Compre melhor. Verifique tudo.",heroTitle:"Planilha Kakobuy, links W2C e guia de QC",heroCopy:"Guia prático de links W2C, fotos QC, frete, cupons e taxas Kakobuy.",heroPrimary:"Spreadsheet",heroSecondary:"Contato pelo WhatsApp ↗",
