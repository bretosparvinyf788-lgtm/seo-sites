...
const ui = {
  en: {
    ...
    productsTitle: "Current Kakobuy Spreadsheet Finds", productsCopy: "Ten live listings from KakobuyMake. Product names, prices and availability can change at the source.",
  ...
  zh: {
    ...
    productsTitle: "当前 Kakobuy 表格精选", productsCopy: "来自 KakobuyMake 的 10 个真实条目；名称、价格和库存以源页面为准。",
  ...
  de: {
    ...
    catTitle:"Kakobuy Spreadsheet nach Kategorie durchsuchen",catCopy:"Zehn klare Wege durch den aktuellen Katalog.",productsTitle:"Aktuelle Funde im Kakobuy Spreadsheet",productsCopy:"Zehn Live-Einträge von KakobuyMake. Preis und Verfügbarkeit können sich ändern.",
