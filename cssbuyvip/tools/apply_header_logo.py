...
# Browser tab icon can still use the asset file.
...
# Inline logo avoids image path / SVG image rendering issues.
...
# Replace existing header and footer brand versions, including previous img version.
...
if html != original:
    ...
    print('Applied inline CSSBuy logo to header/footer and favicon')
else:
