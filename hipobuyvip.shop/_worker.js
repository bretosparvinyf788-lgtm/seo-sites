...
function home(html) {
  ...
  html = html
    ...
    .replace(/<span class="edition">[\s\S]*?<\/span>/i, '<span class="edition">UPDATED SEPTEMBER 8, 2026</span>')
