...
const latest = `<div class="story-grid"><article class="story-card feature"><a aria-label="Read Hipobuy out-of-stock recovery guide" class="story-art numeral" href="${ROUTES['article-stock']}">13</a><small>STOCK & REFUND RECOVERY · 14 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-stock']}">Hipobuy Out-of-Stock Recovery 2026: Refund Ledgers, Replacement Links and Haul Deadlines</a></h3><p>Recover from seller stock cancellations with a refund ledger, fresh replacement-link checks, warehouse deadlines and new QC gates.</p><a href="${ROUTES['article-stock']}">READ STORY →</a></article><article class="story-card"><a aria-label="Read Hipobuy bundle verification guide" class="story-art checker" href="${ROUTES['article-bundles']}">12</a><small>BUNDLE & QUANTITY CONTROL · 14 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-bundles']}">Hipobuy Bundle Verification Protocol 2026: Count Pieces, Match Sets and Stop Partial Orders Before Shipping</a></h3><p>Turn multi-piece Taobao and 1688 listings into countable warehouse checks before an incomplete set reaches your parcel.</p><a href="${ROUTES['article-bundles']}">READ STORY →</a></article><article class="story-card"><a aria-label="Read Hipobuy late-seller control guide" class="story-art percentage" href="${ROUTES['article-late-seller']}">11</a><small>WAREHOUSE TIMING CONTROL · 13 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-late-seller']}">Hipobuy Late-Seller Control 2026: Warehouse Cutoffs, QC Holds and Split-Parcel Decisions</a></h3><p>Manage late sellers without freezing an entire haul by using arrival priorities, QC release states, parcel cutoffs and live split-shipping comparisons.</p><a href="${ROUTES['article-late-seller']}">READ STORY →</a></article></div><button class="mobile-all-guides" data-open-panel="guide-hub" type="button">VIEW ALL SEO ARTICLES →</button>`;
...
const currentLatest = `<div class="story-grid"><article class="story-card feature"><a aria-label="Read Hipobuy rehearsal packing guide" class="story-art numeral" href="${ROUTES['article-rehearsal']}">14</a><small>REHEARSAL PACKING CONTROL · 14 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-rehearsal']}">Hipobuy Rehearsal Packing 2026: Confirm Weight, Packaging and Shipping Before You Pay</a></h3><p>Freeze the warehouse group, define packaging, review packed dimensions and confirm the live route before final international payment.</p><a href="${ROUTES['article-rehearsal']}">READ STORY →</a></article><article class="story-card"><a aria-label="Read Hipobuy out-of-stock recovery guide" class="story-art checker" href="${ROUTES['article-stock']}">13</a><small>STOCK & REFUND RECOVERY · 14 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-stock']}">Hipobuy Out-of-Stock Recovery 2026: Refund Ledgers, Replacement Links and Haul Deadlines</a></h3><p>Recover from seller stock cancellations with a refund ledger, fresh replacement-link checks, warehouse deadlines and new QC gates.</p><a href="${ROUTES['article-stock']}">READ STORY →</a></article><article class="story-card"><a aria-label="Read Hipobuy bundle verification guide" class="story-art percentage" href="${ROUTES['article-bundles']}">12</a><small>BUNDLE & QUANTITY CONTROL · 14 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-bundles']}">Hipobuy Bundle Verification Protocol 2026: Count Pieces, Match Sets and Stop Partial Orders Before Shipping</a></h3><p>Turn multi-piece Taobao and 1688 listings into countable warehouse checks before an incomplete set reaches your parcel.</p><a href="${ROUTES['article-bundles']}">READ STORY →</a></article></div><button class="mobile-all-guides" data-open-panel="guide-hub" type="button">VIEW ALL SEO ARTICLES →</button>`;

const currentAllGuides = allGuides.replace('<div class="guide-hub-grid">', `<div class="guide-hub-grid"><a class="guide-static-link" href="${ROUTES['article-rehearsal']}"><span>14 · SEPTEMBER 6, 2026 · REHEARSAL PACKING CONTROL</span><b>Hipobuy Rehearsal Packing 2026: Confirm Weight, Packaging and Shipping Before You Pay</b><small>Warehouse manifests, packing instructions, completed dimensions, chargeable-weight checks and shipping confirmation.</small></a>`);
...
function home(html) {
  ...
  html = html
    ...
    .replace(/<span class="edition">[\s\S]*?<\/span>/i, '<span class="edition">UPDATED SEPTEMBER 6, 2026</span>')
