...
const currentLatest = `<div class="story-grid"><article class="story-card feature"><a aria-label="Read Hipobuy review" class="story-art numeral" href="${ROUTES['article-review']}">18</a><small>INDEPENDENT HIPOBUY REVIEW · 13 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-review']}">Hipobuy Review 2026: Legit? Fees, QC, Shipping and Returns</a></h3><p>Separate the platform's published workflow from seller quality, total cost, route restrictions and policy risk.</p><a href="${ROUTES['article-review']}">READ STORY →</a></article><article class="story-card"><a aria-label="Read Hipobuy tracking guide" class="story-art checker" href="${ROUTES['article-tracking']}">17</a><small>TRACKING & ORDER STATUS · 13 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-tracking']}">Hipobuy Tracking 2026: Order Status and Parcel Updates</a></h3><p>Map seller, warehouse, parcel, carrier and customs events before escalating tracking that is not updating.</p><a href="${ROUTES['article-tracking']}">READ STORY →</a></article><article class="story-card"><a aria-label="Read Hipobuy insurance guide" class="story-art percentage" href="${ROUTES['article-insurance']}">16</a><small>INSURANCE & COMPENSATION · 13 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-insurance']}">Hipobuy Insurance 2026: Lost, Damaged and Customs Claims</a></h3><p>Match the route to current protection terms, preserve evidence and build a deadline-safe parcel claim.</p><a href="${ROUTES['article-insurance']}">READ STORY →</a></article></div><a class="mobile-all-guides" href="/guides/">VIEW ALL BUYER GUIDES →</a>`;
