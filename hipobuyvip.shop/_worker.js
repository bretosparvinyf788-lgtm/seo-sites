...
function home(html) {
  ...
  html = html
    ...
    .replace(/<div class="topbar">[\s\S]*?<\/div>/i, '<div class="topbar">UPDATED AUGUST 2026 · INDEPENDENT HIPOBUY BUYER RESEARCH · CHECK LIVE TERMS BEFORE ORDERING</div>')
    .replace(/<span class="edition">[\s\S]*?<\/span>/i, '<span class="edition">UPDATED AUGUST 17, 2026</span>')
