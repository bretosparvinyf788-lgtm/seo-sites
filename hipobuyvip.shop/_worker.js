...
const latest = `<div class="story-grid"><article class="story-card feature"><a aria-label="Read Hipobuy parcel scenario planning guide" class="story-art numeral" href="${ROUTES['article-parcel']}">07</a><small>PARCEL SCENARIO PLANNING · 13 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-parcel']}">Hipobuy Parcel Scenario Planning 2026: Compare Compact, Protected and Split Shipping Plans</a></h3><p>Compare three warehouse-to-door parcel plans with live route quotes, packing trade-offs, coupon checks and a traceable checkout record.</p><a href="${ROUTES['article-parcel']}">READ STORY →</a></article><article class="story-card"><a aria-label="Read Hipobuy returns and exchanges guide" class="story-art numeral" href="${ROUTES['article-returns']}">06</a><small>RETURN &amp; EXCHANGE CONTROL · 14 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-returns']}">Hipobuy Return &amp; Exchange Decision Desk 2026: Evidence, Seller Timing and Warehouse Release</a></h3><p>Build a warehouse evidence packet, track seller decisions and release only resolved inventory into a parcel.</p><a href="${ROUTES['article-returns']}">READ STORY →</a></article><article class="story-card"><a aria-label="Read Hipobuy W2C link control guide" class="story-art checker" href="${ROUTES['article-w2c']}">05</a><small>W2C ORDER CONTROL · 14 MIN</small><h3><a class="story-title-link" href="${ROUTES['article-w2c']}">Hipobuy W2C Link Control 2026: Lock Variants, Seller Instructions and Warehouse Exceptions</a></h3><p>A link-to-parcel control system for exact variants, seller questions, payment checks and warehouse exceptions.</p><a href="${ROUTES['article-w2c']}">READ STORY →</a></article></div><button class="mobile-all-guides" data-open-panel="guide-hub" type="button">VIEW ALL SEO ARTICLES →</button>`;
...
function home(html) {
  ...
  html = html
    ...
    .replace(/<span class="edition">[\s\S]*?<\/span>/i, '<span class="edition">UPDATED JULY 30, 2026</span>')
